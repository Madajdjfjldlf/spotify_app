...
class _SettingPageState extends State<SettingPage> {
  ...
  Future<void> _logout() async {
    ...
    try {
      ...
      // الانتقال إلى صفحة تسجيل الدخول (مع مسح المكدس بالكامل)
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            // ─── Profile Header (مع بيانات المستخدم الحقيقية) ───
            _ProfileHeader(
              isDark: isDark,
              textColor: textColor,
            ...
            // ─── Experience ───
            _SectionTitle(title: 'Experice', isDark: isDark),
            const SizedBox(height: 12),
            CustomSettingGroup(
              items: [
                Settingdata(
            ...
            BlocBuilder<ThemeCubit, ThemeMode>(
              builder: (context, mode) {
                // التحقق ممّا إذا كان الثيم الحالي مظلماً
                ...
                return CustomSettingGroup(
                  items: [
                    Settingdata(
                      ...
                      iconColor: const Color(0xFF667EEA),
                      isSwitch: true,
                      switchValue: isDarkModeActive,
                      onSwitchChanged: (v) {
                        // تحديث الثيم في الـ Cubit وحفظه

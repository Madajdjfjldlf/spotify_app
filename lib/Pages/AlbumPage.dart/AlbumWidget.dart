...
class Catogriesalbum extends StatefulWidget {
  const Catogriesalbum({
    ...
    required this.albumId, // ✅ أضف هذا السطر
    this.previewUrl,
    this.songTitle,
    this.artistName,
  });
  ...
  final String albumId; // ✅ أضف هذا السطر
...
class _CatogriesalbumState extends State<Catogriesalbum>
  ...
  Future<void> _onTap() async {
    ...
    // ✅ الانتقال إلى صفحة الألبوم مع تمرير المعرف
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) =>
                ...
                children: [
                  ...
                  TweenAnimationBuilder<double>(
                    ...
                    builder: (context, value, child) {
                      return Positioned(left: value, top: 10, child: child!);
                    },
